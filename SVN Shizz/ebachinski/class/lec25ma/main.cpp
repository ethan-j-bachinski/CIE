...
void miniAssignmentTreeRepresentation2()
{
    ...
    */
    ...
    rootPtr->rightPtr = createNewTreeNode(36);
    rootPtr->leftPtr->rightPtr = createNewTreeNode(45);
    rootPtr->rightPtr->leftPtr = createNewTreeNode(39);
    rootPtr->leftPtr->leftPtr=createNewTreeNode(37);
    rootPtr->rightPtr->rightPtr=createNewTreeNode(42);
    rootPtr->leftPtr->leftPtr->rightPtr=createNewTreeNode(44);
    rootPtr->rightPtr->rightPtr->leftPtr=createNewTreeNode(56);
